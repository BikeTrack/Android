package eu.biketrack.beta.api_connection;

import eu.biketrack.beta.models.data_reception.AuthenticateReception;
import eu.biketrack.beta.models.data_reception.ReceiveBike;
import eu.biketrack.beta.models.data_reception.ReceiveTracker;
import eu.biketrack.beta.models.data_reception.ReceptAddBike;
import eu.biketrack.beta.models.data_reception.ReceptDeleteUser;
import eu.biketrack.beta.models.data_reception.ReceptUser;
import eu.biketrack.beta.models.data_reception.ReceptUserUpdate;
import eu.biketrack.beta.models.data_reception.SignupReception;
import eu.biketrack.beta.models.data_send.AuthUser;
import eu.biketrack.beta.models.data_send.DeleteUser;
import eu.biketrack.beta.models.data_send.SendBike;
import eu.biketrack.beta.models.data_send.SendBikeUpdate;
import eu.biketrack.beta.models.data_send.SendUserUpdate;
