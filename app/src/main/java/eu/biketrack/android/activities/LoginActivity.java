...
//        });
        ...
        Button mEmailSubscribeButton = (Button) findViewById(R.id.email_subscribe_button);
        mEmailSubscribeButton.setOnClickListener(new OnClickListener() {
            @Override
...
//    }
    ...
    private void attemptLogin(Boolean connexion) {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, connexion);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final Boolean mConnexion;

        UserLoginTask(String email, String password, Boolean connexion) {
            mEmail = email;
            mPassword = password;
...
//                Toast.makeText(getApplicationContext(), e.getMessage(), Toast.LENGTH_LONG);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Log.d("Output:", "Terminated");
                openBikesActivity();
                Log.d("Output:", "Before finish");
                finish();
            } else {
