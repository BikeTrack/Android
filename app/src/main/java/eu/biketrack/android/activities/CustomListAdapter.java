...
public class CustomListAdapter extends ArrayAdapter<Bike> {
    ...
    public CustomListAdapter(Activity context, Bike[] bikes) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        txtTitle.setText(bikes[position].getName());
        //imageView.setImageResource(imgid[position]);
        extratxt.setText("Latitude : " + bikes[position].getLat() + " Longitude : " + bikes[position].getLong());
        return rowView;
    };
}
